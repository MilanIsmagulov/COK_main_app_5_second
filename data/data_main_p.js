...
const textOfMethodMaterials = [
    ...
    Обратите внимание на основные вопросы лекции: - Селективная очистка масел фенолом;<br>- Требования, предъявляемые к сырью, полуфабрикатам и готовой продукции в соответствии с нормативной документацией; <br>- Параметры процесса; <br>- Устройство и принцип действия экстрактора;<br>- Технологические схемы селективной очистки.<br>
    ...
    В ходе занятия преподавателю предлагается, опираясь на материалы данного ЭОМ  раскрыть следующие вопросы:<br>- Селективная очистка масел фенолом;<br>- Требования, предъявляемые к сырью, полуфабрикатам и готовой продукции в соответствии с нормативной документацией;<br>- Параметры процесса;<br>- Устройство и принцип действия экстрактора;<br>- Технологические схемы селективной очистки.`,
    `<p class='pink_subtitle'>Рекомендации для обучающегося</p>
